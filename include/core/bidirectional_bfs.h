...
class BidirectionalBFS {
   private:
    Graph *board_graph_;
    void BFS(queue<size_t> &next_nodes, vector<bool> &visited_nodes);
   ...
   public:
     ...
     */
    BidirectionalBFS(Graph *board_graph);
     ...
     */
    vector<vector<int>> RunBidirectionalBFS(size_t end_row, size_t end_col);
  };
